...
# https://github.com/rome/tools/releases/tag/cli/v10.0.0
PLATFORMS = {
    "darwin-arm64": struct(
        compatible_with = [
            "@platforms//os:macos",
...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@build_bazel_rules_rome//rome:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.romeinfo,
...
# By default all these toolchains are registered by the rome_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:rome_toolchain",
    toolchain_type = "@build_bazel_rules_rome//rome:toolchain_type",
)
""".format(
            platform = platform,
